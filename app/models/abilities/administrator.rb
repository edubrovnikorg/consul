module Abilities
  class Administrator
    ...
    def initialize(user)
      ...
      can [:search, :index, :approve], ::User

      can :manage, Dashboard::Action

      can [:index, :read, :new, :create, :update, :destroy, :calculate_winners, :next_phase, :delete_all, :read_results], Budget
      can :publish, Budget, id: Budget.drafting.ids
      can [:read, :create, :update, :destroy], Budget::Group
      can [:read, :create, :update, :destroy], Budget::Heading
      can [:create, :hide, :admin_update, :toggle_selection, :delete_all], Budget::Investment
